...
<div class="content">
	...
	<div class="content2">
		...
		<div class="content2-header1">
			<p>Estado: <span>{!! $nombre_estado !!}</span></p>
		</div>
		<div class="content2-header1">
	...
	<div class="content3">
        <div class="shipment">
			<img src="https://i.ibb.co/5MKcbVg/tracking.png" style="width:100%;">
			<div class="confirm">	
                <div class="imgcircle realizado">
                    <!-- <img src="{{asset('assets/email_images/confirm.png')}}" alt="recibido"> -->
					<i class="fas fa-receipt" style="font-size:40px;margin-top:22%"></i>
            	</div>
				<span class="line realizado"></span>
				<p>Recibido</p>
			</div>
			<div class="process">
           	 	<div class="imgcircle realizado">
                	<img src="{{asset('assets/email_images/process.png')}}" alt="aprobado seguro">
            	</div>
				<span class="line realizado"></span>
				<p>Aprobado por Seguro</p>
			</div>
			<!-- DEBE HABER UNA LINEA CLASE REALIZADO ANTES DE LA ULTIMA IMAGEN CLASE REALIZADO -->
			<div class="quality">
				<div class="imgcircle realizado">
                	<img src="{{asset('assets/email_images/quality.png')}}" alt="aprobado cliente">
            	</div>
			...
			<div class="dispatch">
				<div class="imgcircle">
                	<img src="{{asset('assets/email_images/dispatch.png')}}" alt="vehiculo listo">
            	</div>
				<span class="line"></span>
				<p>Vehículo Listo</p>
			</div>
			<div class="delivery">
				<div class="imgcircle">
                	<!-- <img src="{{asset('assets/email_images/delivery.png')}}" alt="entregado"> -->
					<i class="fas fa-truck-moving" style="font-size:40px;margin-top:22%"></i>
				</div>
				<p>Entregado</p>
			</div>
			<div class="clear"></div>
