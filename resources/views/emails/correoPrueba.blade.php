...
<div class="content">
	<div class="content1">
		<h2>N° Orden de Servicio: {!! $nroOT !!}</h2>
	</div>
	<div class="content2">
		<div class="content2-header1">
			<p>Placa Vehicular: <span>{!! $nro_placa !!}</span></p>
		</div>
		<div class="content2-header1">
			<p>Estado: <span>{!! $nombre_estado !!}</span></p>
		</div>
		<div class="content2-header1">
			<p>Modelo: <span>{!! $modelo_auto !!}</span></p>
		</div>
		<div class="clear"></div>
	</div>
	<div class="content3">
        <div class="shipment">
			<img src="https://i.ibb.co/5MKcbVg/tracking.png" style="height:100%;">
			<div class="clear"></div>
		</div>
	</div>
</div>
