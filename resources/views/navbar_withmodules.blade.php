                    ...
                    <div class="collapse"
                        ...
                        <nav class="sb-sidenav-menu-nested nav">
                            ...
                            @if (Auth::user()->tienePermiso('submodulo_reporteCitas'))
                                <a class="nav-link"
                                   modulo="submodulo_reporteCitas"
                                   href="{{ route('reportes.citas') }}">Resumen de Citas</a>
                            @endif
                            @if (Auth::user()->tienePermiso('submodulo_movimientoRepuestos'))
                                <a class="nav-link"
                                   modulo="submodulo_movimientoRepuestos"
                                   href="{{ route('reportes.movimientoRepuestos') }}">Movimiento de Repuestos</a>
                            @endif
                            @if (Auth::user()->tienePermiso('submodulo_reporteProductividad'))
                                <a class="nav-link"
                                   modulo="submodulo_reporteProductividad"
                                   href="{{ route('reportes.productividad') }}">Reporte de Productividad</a>
                            @endif
                            @if (Auth::user()->tienePermiso('submodulo_reporteGeneral'))
                                <a class="nav-link"
                                   modulo="submodulo_reporteGeneral"
                                   href="{{ route('reportes.reporteGeneral') }}">Reporte General</a>
                            @endif

                            @if (Auth::user()->tienePermiso('submodulo_reporteVentaRepuestos'))
                                <a class="nav-link"
                                   modulo="submodulo_reporteVentaRepuestos"
                                   href="{{ route('reportes.consulta.ventaRepuestos') }}">Reporte Venta
                                    Repuestos</a>
                            @endif
                            @if (Auth::user()->tienePermiso('submodulo_reporteOTS'))
                                <a class="nav-link"
                                   modulo="submodulo_reporteOTS"
                                   href="{{ route('reportes.consulta.ots') }}">Reporte OT's</a>
                            @endif
                            @if (Auth::user()->tienePermiso('submodulo_reporteInventario'))
                                <a class="nav-link"
                                   modulo="submodulo_reporteInventario"
                                   href="{{ route('reportes.consulta.stock') }}">Inventario</a>
                            @endif
                            @if (Auth::user()->tienePermiso('submodulo_reporteVentas'))
                                <a class="nav-link"
                                   modulo="submodulo_reporteVentas"
                                   href="{{ route('reportes.consulta.ventas') }}">Reporte de Ventas</a>
                            @endif
