...
<div class="modal fade"
     id="registrarClienteModal"
     tabindex="-1"
     role="dialog"
     aria-labelledby="registrarClienteLabel"
     aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header fondo-sigma">
                <h5 class="modal-title"
                    id="registrarClienteLabel">Registrar Cliente</h5>
                <button type="button"
                        class="close"
                        data-dismiss="modal"
                        aria-label="Close">
            ...
            <div class="modal-body"
                ...
                <form id="FormRegistrarCliente"
                      method="POST"
                      action="{{ route('administracion.clientes.store') }}"
                      value="Submit"
                      autocomplete="off">
                    @csrf
