...
@section('titulo','Modulo de contabilidad - Crear OC Vehiculo Nuevo')
...
<div id="containerMec" class="mx-auto" style="background: white;padding: 15px">
   <div class="row">
      <div class="col-12 mt-2 d-flex justify-content-between align-items-center">
         <h2 class="ml-3 mt-3 mb-4">Generar Orden de Compra de Vehiculo Nuevo</h2>
         ...
         <div class="card">
            <div class="card-body row">
               ...
               <div class="col-3">
                  ...
                  {!! Form::select('empresa',  $empresa, '1', ['class' => 'form-control form-control-sm', 'id' => 'empresa', 'disabled']) !!}
               </div>

               <div class="col-3">
                  {!! Html::decode(Form::label('sucursal', 'Sucursal <span class="text-danger font-weight-normal h6 ml-1">*</span>', ['class' => 'font-weight-bold'])) !!}
                  {!! Form::select('sucursal', ['1' => 'LOS OLIVOS'] , '1', ['class' => 'form-control form-control-sm', 'id' => 'sucursal']) !!}
               ...
               <div class="col-3">
                  ...
                  {!! Form::select('almacen',  $almacenes, null, ['class' => 'form-control form-control-sm', 'id' => 'almacen']) !!}
               ...
               <div class="col-3">
                  ...
                  {!! Form::select('moneda', ['' => 'SELECCIONAR'] + ['DOLARES' => 'DOLARES', 'SOLES' => 'SOLES'] , null, ['class' => 'form-control form-control-sm', 'id' => 'moneda']) !!}
               ...
               <div class="col-3">
                  ...
                  {!! Form::select('motivooc', $motivosOC, null, ['class' => 'form-control form-control-sm', 'id' => 'motivooc']) !!}
               ...
               <div class="col-3" id="proveedor_typeahead">
                  {!! Html::decode(Form::label('proveedor', 'Proveedor <span class="text-danger font-weight-normal h6 ml-1">*</span>', ['class' => 'font-weight-bold mt-1'])) !!} <div class="input-group">
                     ...
                     {!! Form::text('proveedor', null, ['class' => 'form-control form-control-sm numeros', 'maxlength' => '11','autocomplete' => 'off','id' => 'proveedor']) !!}
               ...
               <div class="table-title">
                  <div class="row col-12 justify-content-between">
                     ...
                     <div class="row justify-content-end">
                        <div>
                           <button id="agregarFila" type="button" style=" margin-left:15px" class="btn btn-warning ">+</button>
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <table id="tablaDetalleOCVN" class="table text-center table-striped table-sm d-none">
                     <thead>
                        <tr>
                           ...
                           <th scope="col" style="width: 10%">NUM. MOTOR</th>
                           ...
                           <th scope="col" style="width: 5%">ESTADO STOCK</th>
                           <th scope="col" style="width: 5%">COSTO UNITARIO</th>
                           <th scope="col" style="width: 5%">DESCUENTO UNITARIO</th>
                           <th scope="col" style="width: 5%">SUB TOTAL</th>
                           <th scope="col" style="width: 5%">ISC</th>
                           <th scope="col" style="width: 5%">IGV</th>
