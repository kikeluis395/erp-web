...
@if (isset($id_recepcion_ot))
            ...
            <div class="col-12 mt-2 mt-sm-0">
                <div class="row justify-content-between">
                    <h2 class="ml-3 mt-3 mb-4">
                        @if (isset($id_recepcion_ot) || isset($datosRecepcionOT)) Órden de Trabajo - MEC
                        @else Cotización - MEC @endif
                    </h2>
                    <div class="justify-content-end">
                        <a
                           href="{{ isset($id_recepcion_ot) || isset($datosRecepcionOT) ? route('mecanica.recepcion.index') : route('mecanica.cotizaciones.index') }}"><button
                                    type="button"
                ...
                @if (isset($id_recepcion_ot) || isset($datosRecepcionOT))
                    @include('sections.dataDetalleTrabajoMEC_OT')
                @elseif(isset($id_cotizacion) || isset($datosRecepcion))
                    @include('sections.dataDetalleTrabajoMEC_Cotizacion')
                @endif
                ...
                @if (false)
                    <div class="row justify-content-end">
                        ...
                        <button id="btnEditarDetalleTrabajoMec"
                                type="button"
                ...
                <div class="row justify-content-between">
                    <div class="form-group form-inline col-6 form-group-align-top">
                        ...
                        <textarea name="observaciones"
                                  type="text"
                                  class="form-control ml-3 col-10"
                                  id="observacionesIn"
                ...
                <div class="row justify-content-end">
                    @if ((isset($esEditableOT) && $esEditableOT) || (isset($esEditableCot) && $esEditableCot))
                        <div>
                            @if (false && isset($id_recepcion_ot) && $datosRecepcionOT->tieneInventario())<a
                                   href="{{ route('inventarioVehiculo.index', ['id_recepcion_ot' => $id_recepcion_ot]) }}"><button
                                            id="btnVerInventarioMec"
                                            type="button"
                                            class="btn btn-success"
                                            style="margin-left:15px">Ver Inventario</button></a>@endif
                            @if (false && isset($id_recepcion_ot) && $datosRecepcionOT->esInventariable())<a
                                   href="{{ route('inventarioVehiculo.index', ['id_recepcion_ot' => $id_recepcion_ot]) }}"><button
                                            id="btnCompletarInventarioMec"
                                            type="button"
                                            class="btn btn-danger"
                        ...
                        @if (false)
                            <div>
                                @if (isset($id_recepcion_ot) && $datosRecepcionOT->tieneInspeccion())<a
                                       href="{{ route('hojaInspeccion', ['nro_ot' => $datosRecepcionOT->id_recepcion_ot]) }}"><button
                                                type="button"
                                                class="btn btn-success btn-tabla">Inspección</button></a>
                                @elseif(isset($id_recepcion_ot))<button type="button"
                                            class="btn btn-danger btn-tabla"
                                            disabled>Inspección</button>@endif
                            </div>
    ...
    @section('table-content')
        <div id="containerMec"
             class="mx-3 contenedorTypeahead"
                ...
                <div class="table-wrapper"
                            ...
                            <div>
                                @if ((isset($esEditableOT) && $esEditableOT) || (isset($esEditableCot) && $esEditableCot))
                                    <button id="btnEditarDetalleTrabajoMec"
                                            type="button"
                                            class="btn btn-warning"
                                            style="margin-left:15px; display: none"></button>
                                    <button id="btnAgregarDetalleTrabajo"
                                            type="button"
                                            style="display: none; margin-left:15px"
                                            class="btn btn-warning">+</button>
                    ...
                    <div class="table-cont-single"
                        ...
                        <form id="formDetallesTrabajo"
                              method="POST"
                              action="{{ route('mecanica.detalle_trabajos.store') }}"
                              autocomplete="off"
                                            ...
                                            @if ((isset($esEditableOT) && $esEditableOT) || (isset($esEditableCot) && $esEditableCot))
                                                <td id="tdEliminarDetalleTrabajo-{{ $detalleTrabajo->id_operacion_trabajo }}"
                                                    ...
                                                    <div id="formEliminarDetalleTrabajo"
                                                         method="POST"
                                                         actionForm="{{ route('mecanica.detalle_trabajos.destroy', ['id_detalle_trabajo' => $detalleTrabajo->id_detalle_trabajo]) }}">
                                                        @csrf
                                                            ...
                                                            <tr>
                                                                ...
                                                                @if (isset($id_cotizacion) || isset($id_recepcion_ot))
                                                                    ...
                                                                    @if (isset($repuestoSolicitado->repuesto))
                                                                        <td>{{ $repuestoSolicitado->getMargenDealer($repuestoSolicitado->descuento_unitario_dealer ?? -1, $repuestoSolicitado->margen) }}
                                                                        </td>
                                                                    @else
                                                                        <td>-</td>
                                                                    @endIf
                                                    ...
                                                    @foreach ($listaServiciosTerceros as $servicioTercero)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                @elseif(is_null($servicioTercero->servicioTercero->pvp) &&
                                                                    !is_null($servicioTercero->pvp_libre)) - @endif
                                                            </td>
                                                            <td>
                                                                {{ App\Helper\Helper::obtenerUnidadMoneda($moneda) }}
                                                                @if (!is_null($servicioTercero->servicioTercero->pvp))
                                ...
                                <div class="mx-auto col-sm-6">
                                    <div class="card shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group form-inline row">
                                                <label class="col-sm-5 col-form-label form-control-label justify-content-end"
                                                   for="totalCotizacion">TOTAL @if (isset($id_cotizacion)) Cotización @else OT
                                                    @endif : </label>
                                                <div class="col-sm-7">
                                                        ...
                                                        <a href="{{ route('hojaEntrega', ['id_recepcion_ot' => $id_recepcion_ot]) }}"
                                                           target="_blank">
                                                            <button id="btnNotaEntrega"
                                                                    type="button"
                                                                    class="btn btn-success"
                                                                    style="margin-left:15px">Imprimir Nota de Entrega</button>
                                                        </a>
                                                    </div>
                                                @else
                                                    <div class="form-group form-inline row"
                                                        ...
                                                        <a
                                                           href="{{ route('hojaLiquidacion', ['nro_ot' => $id_recepcion_ot]) }}"><button
                                                                    ...
                                                                    type="button"
                                                                    class="btn btn-success"
                                                                    style="margin-left:15px">Imprimir Liquidacion</button></a>
                                                    </div>
                ...
                <div class="col-xl-12 p-0 mt-3">
                    ...
                    <div class="row justify-content-between m-0">
                        @if ((isset($esEditableOT) && $esEditableOT) || (isset($esEditableCot) && $esEditableCot))
                            ...
                            @if (isset($id_cotizacion)) @include('modals.cerrarCotizacion') @endif
                            @if (isset($id_cotizacion))
                                <div class="btn-group"
                                     role="group">
                        ...
                        @endif
                        @if (isset($id_recepcion_ot))
                            <a href="{{ route('hojaOT', ['nro_ot' => $id_recepcion_ot]) }}">
                                <button id="btnHojaOT"
                                        type="button"
                                        class="btn btn-success"
                                        style="margin-left:15px">Imprimir OT</button>
                            </a>
                        @endif
