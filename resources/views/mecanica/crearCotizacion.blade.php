...
@section('titulo','Modulo de recepción - Registrar Cotizacion MEC') 
...
<div class="mx-3" style="overflow-y:auto;background: white;padding: 15px 10px 10px 15px">
  <div class="row justify-content-between col-12">
    <h2 class="ml-3 mt-3 mb-0">Registro de Cotización - Mecánica</h2>
  </div>
  <p class="ml-3 mt-3 mb-4">Ingrese los datos del cliente para continuar con el registro</p>
  <form class="col-xl-6" id="FormRegistrarRecepcion" method="POST" action="{{route('mecanica.cotizaciones.store')}}" value="Submit" autocomplete="off" onkeydown="return event.key != 'Enter';">
    @csrf
