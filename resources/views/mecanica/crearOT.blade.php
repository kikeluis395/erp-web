...
@section('titulo', 'Modulo de recepción - Registrar OT MEC')
...
@section('table-content')
    <div class="mx-3"
        ...
        <div class="row justify-content-between col-12">
            <h2 class="ml-3 mt-3 mb-0">Registro de OT - Mecánica</h2>
        </div>
        <p class="ml-3 mt-3 mb-12">Ingrese los datos del cliente para continuar con el registro</p>
        <form class="col-xl-12"
              id="FormRegistrarRecepcion"
              method="POST"
              action="{{ route('mecanica.recepcion.store') }}"
              value="Submit"
              autocomplete="off"
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        {{-- <div class="col-3">
                            <div class="form-group row ">
                                <label for="clienteIn"
                                       class="col-4  justify-content-end">Cliente:</label>
                                <div class="col-5">
                                    <input name="cliente"
                                           type="text"
            ...
            <div class="card mt-4"
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        {{-- <div class="col-3">
          <div class="form-group row mb-3">
            <label for="telfContactoInExt2" class="col-4 justify-content-end">Telf. Contacto:</label>
            <div class="col-8">
              <input name="telfContacto2" type="text" class="form-control col-lg-12" id="telfContactoInExt2" style="width:100%"  placeholder="Ingrese el teléfono del contacto" disabled>            
            </div>
          </div>
        </div>
        ...
        <div class="col-3">
          <div class="form-group row mb-3">
            <label for="correoContactoInExt2" class="col-4 justify-content-end">Correo Contacto:</label>
            <div class="col-8">
              <input name="correoContacto2" type="text" class="form-control col-lg-12" id="correoContactoInExt2" style="width:100%" placeholder="Ingrese segundo correo del contacto" disabled>
            </div>
          </div>
        </div> --}}
