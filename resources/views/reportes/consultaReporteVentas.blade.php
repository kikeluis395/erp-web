...
<div style="background: white;padding: 10px">
  <div class="row justify-content-between col-12">
    <h2>Reportes - Ventas MEC y B&P</h2>
  </div>
  <div id="busquedaForm" class="col-12 borde-tabla" style="background: white;margin-top:10px">
    <form id="FormObtenerReporteKardex" class="my-3 mr-3" method="GET" action="{{route('reportes.ventas.export')}}" onsubmit="return submitReporteVentasTaller()" value="search">
      <div class="row">
