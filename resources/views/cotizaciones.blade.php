@extends('tableCanvas')
@section('titulo','Modulo de recepción - Cotizaciones B&P') 

@section('pretable-content')
<div style="background: white;padding: 10px">
  <h2 class="ml-3 mt-3 mb-4">Cotizaciones - B&P</h2>
  <div id="busquedaCollapsable" class="col-12 collapse borde-tabla" style="background: white;margin-top:10px">
    <form id="FormFiltrarRecepcion" class="my-3" method="GET" action="{{route('cotizaciones.index')}}" value="search">
      <div class="row">
        @if(false)
        ...
        @if(false && in_array(Auth::user()->id_rol,[1,6]))
        <div class="form-group row ml-1 col-12 col-sm-6 col-lg-3">
        ...
        <table class="table text-center table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="{{route('detalle_trabajos.index',['id_cotizacion'=>$cotizacion->id_cotizacion])}}"><button type="button" class="btn btn-warning"><i class="fas fa-info-circle icono-btn-tabla"></i>  </i></button></a></td>
            </tr>
            @endforeach
          </tbody>
        </table>
...
@section('extra-scripts')
  @parent
  <script src="{{asset('js/recepcion.js?v='.time())}}"></script>
@endsection