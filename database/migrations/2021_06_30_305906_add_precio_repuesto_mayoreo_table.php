...
class AddPrecioRepuestoMayoreoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('precio_repuesto_mayoreo', function (Blueprint $table) {
            $table->increments('id_precio_repuesto_mayoreo');
