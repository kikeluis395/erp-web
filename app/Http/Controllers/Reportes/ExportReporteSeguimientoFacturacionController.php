...
class ExportReporteSeguimientoFacturacionController implements WithTitle,FromView, ShouldAutoSize, WithEvents
{
    private $resultados = [];
    ...
    {
        return 'SEGUIMIENTO FACTURACION';
    }
    ...
    public function view(): View
    {
        ...
        return view('reportes.reporteSeguimientoFacturacion', ["resultados" => $resultados]);
    }
