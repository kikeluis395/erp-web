...
class ExportReporteInformesRepuestosObsoletosViewController implements WithTitle,FromView, ShouldAutoSize, WithEvents
{
    private $resultados = [];
    private $title = '';

    public function __construct($resultados, $title)
    {
    ...
    public function view(): View
    {
        ...
        return view('reportes.reporteRepuestosObsoletos', ["resultados" => $resultados]);
    }
