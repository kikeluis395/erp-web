...
class ExportReporteComprasController implements WithTitle,FromView, ShouldAutoSize, WithEvents
{
    private $resultados = [];
    ...
    public function view(): View
    {
        ...
        return view('reportes.reporteComprasExcel', ["resultados" => $resultados]);
    }
