...
class ExportReporteVentasMesonViewController implements WithTitle,FromView, ShouldAutoSize, WithEvents
{
    private $resultados = [];
    private $tipo = false;

    public function __construct($resultados, $tipo = false)
    {
    ...
    public function view(): View
    {
        ...
        if($this->tipo) return view('reportes.reporteVentasMesonRepuestos', ["resultados" => $resultados]);

        return view('reportes.reporteVentasHojaMeson', ["resultados" => $resultados]);
    }
