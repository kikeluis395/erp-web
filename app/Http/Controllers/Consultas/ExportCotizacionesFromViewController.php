...
class ExportCotizacionesFromViewController implements WithTitle, FromView, ShouldAutoSize, WithEvents
{
    ...
    public function view(): View
    {
        ...
        return view('consultas.cotizacionesExport', ["listaCotizaciones" => $cotizaciones]);
    }
    public function title(): string
    {
        return 'REPORTE COTIZACIONES';
    }
