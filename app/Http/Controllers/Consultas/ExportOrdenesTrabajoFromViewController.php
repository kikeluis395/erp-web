...
class ExportOrdenesTrabajoFromViewController implements WithTitle, FromView, ShouldAutoSize, WithEvents
{
    private $ordenesTrabajo = [];

    public function __construct($listaOrdenesTrabajo)
    {
        $this->ordenesTrabajo = $listaOrdenesTrabajo;
    }
    ...
    public function view(): View
    {
        ...
        return view('consultas.ordenesTrabajoExport', ["listaOrdenesTrabajo" => $ordenesTrabajo]);
    }

    public function title(): string
    {
        return 'REPORTE ORDENES DE TRABAJO';
    }

    public function registerEvents(): array
    {
        $data = $this->ordenesTrabajo;
        return [
